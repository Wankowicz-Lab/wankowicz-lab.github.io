...
### The lab is interested in determining the mechanisms driving the binding specificity and catalysis. 

We view this problem from a thermodynamic and structural lens. 

Our approaches to answering these key questions include:

1) Developing novel algorithms that model the conformational ensemble *hidden* in experimental data.
   
3) Connecting structure to biophysical binding measurements, strongly focusing on quantitative entropy metrics.
   
4) Using machine learning, bioinformatics, and machine learning to identify how conformational ensembles, considering the enthalpic and entropic portion, impact binding specificity and catalysis.
...
###How do we decipher the structural contributions of entropy and enthalpy in binding affinity and catalysis?
